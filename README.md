...
<p align="left" >Hi there! I've been working as a Front-End Developer for over a year 👨🏽‍💻<br> I am proficient in using React and JavaScript to build stunning and interactive web applications that engage and satisfy the end-users.<br><br>Meanwhile, team collaborating across Agile/Scrum Methodologies has led me to dive deep into data structures to understand how to efficiently manage and organize large data sets for great project scalability (🚂,⛵) => (🚄,🚢)</p>
</div>
